...
function onPageLoad() {
  ...
  $.get(url,function(data, status) {
      ...
      if(data) {
          ...
          console.log("Locations array:", locations);  // ADD THIS
          console.log("Number of locations:", locations.length);  // ADD THIS
          ...
          for(var i in locations) {
              console.log("Adding location:", locations[i]);  // ADD THIS
